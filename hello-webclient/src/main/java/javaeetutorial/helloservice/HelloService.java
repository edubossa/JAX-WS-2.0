 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://helloservice.javaeetutorial/", wsdlLocation = "http://localhost:8080/helloservice-war/Hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/helloservice-war/Hello?wsdl");
